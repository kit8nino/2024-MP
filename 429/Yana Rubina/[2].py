...
D = []
with open("текст2.txt", encoding="utf-8") as f:
    for line in f:
...
print('До: ',D[5:20],'\n')
print('По длине: ',radix_sort(D[5:20],10))