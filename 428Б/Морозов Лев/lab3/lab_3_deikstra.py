...
#Алгоритм Дейкстры поиска пути от начальной точки до ключа от выхода
...
deikstra(x_0, y_0, my_maze)
a_star(x_key, y_key, my_maze, max_path_length=3300)
maze_output('maze_for_me_done_deikstra_and_a_star.txt', my_maze)