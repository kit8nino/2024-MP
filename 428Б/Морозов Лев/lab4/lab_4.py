...
class Flying_objects_creator:
    ...
    def objects_creation(x_radar,y_radar):
        for i in range (Flying_objects_creator.N):
            ...
            Flying_objects_creator.flying_objects.append(Flying_object(x_object,y_object,z_object,vx_object,vy_object,vz_object))
        return Flying_objects_creator.flying_objects
    
class Coordinates_of_flying_objects_shower:
...
def main():
    ...
    flying_objects = Flying_objects_creator.objects_creation(radar.x_radar, radar.y_radar)
    ...
    Coordinates_of_flying_objects_shower.coordinates_showing(radar, flying_objects)
