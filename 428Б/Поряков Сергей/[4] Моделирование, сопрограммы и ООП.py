...
class FlyingObject:
    ...
    def get_spherical_coordinates(self):
        ...
        azimut = math.degrees(math.atan2(dy, dx))
        ugol = math.degrees(math.asin(dz / r))

        return r, azimut, ugol
...
for obj in objects:
    r, azimut, ugol = obj.get_spherical_coordinates()
    print(f"Объект: Расстояние - {r} м, Азимут - {azimut} градусов, Угол места - {ugol} градусов")
