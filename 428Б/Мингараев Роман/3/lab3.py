...
def Maze_Reader():
    ...
    with open("3\\maze-for-u.txt") as maze2:
        for line in maze2:
...
print("Координаты начальной точки:", start_point)
print("Координаты конечной точки:",end_point)
...
print("Координаты '*':",treasure_is_here)
...
print("УРА УРА УРА!!! Мы нашли выход :D")