...
for object in objects:
    x1 = object.coordinates.x + object.velocity[0] * time
    y1 = object.coordinates.y + object.velocity[1] * time
    z1 = object.coordinates.z + object.velocity[2] * time
    new_coordinates = Coordinates(x1, y1, z1)
