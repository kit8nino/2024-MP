...
class Radar:
    ...
    def send_pulse(self, azimuth, elevation):
        # отправить радиоимпульс
        pass

    def receive_pulse(self, object_coordinates):
        # получить отраженный радиоимпульс
        pass
...
for object in objects:
    n_x = object.coordinates.x + object.velocity[0] * time
    n_y = object.coordinates.y + object.velocity[1] * time
    n_z = object.coordinates.z + object.velocity[2] * time
    n_coordinates = Coordinates(new_x, new_y, new_z)
    r, azimuth, elevation = n_coordinates.to_spherical()
