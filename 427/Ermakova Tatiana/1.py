...
# В списке 16 городов, так как день рождения 1 числа то взят 1 (москва)
topNames = ("Мария", "Екатерина", "Анастасия", "Анна", "Елена", "Ольга", "Наталья", "Ирина", "Татьяна", "Марина")
topSurnames = ("Иванова", "Петрова", "Смирнова", "Кузнецова", "Волкова", "Романова", "Новикова", "Миронова")
names = []
for i in range(30):
...
# 9.
points = {0: "Трусово",
	"Трусово": "Болотная Рогавка",
	"Болотная Рогавка": "Засосная",
	"Засосная": "Дешевки",
	"Дешевки": "Дураково",
	"Дураково": "Безводовка",
	"Безводовка": "Синегубово",
	"Синегубово": 0}
