...
western_actor = ("Генри Фонда", datetime.date(1905, 5, 16))


men_names = [
    'Иван', 'Александр', 'Сергей', 'Андрей', 'Дмитрий', 
    'Алексей', 'Максим', 'Евгений', 'Владимир', 'Денис'
]

women_names = [
    'Екатерина','Елена' ,'Мария' ,'Анастасия', 
    'Ольга','Наталья','Татьяна', 'Анна' , 'Ирина', 'Юлия'
]

men_surnames = [
    'Иванов', 'Петров', 'Смирнов','Сергеев' ,'Васильев' ,'Кузнецов' , 
    'Андреев', 'Попов'
]
...
list.append("1 Баклань")
list.append("2 Лохово")
list.append("3 Ломки")
list.append("4 Крутая")
list.append("5 Цаца")
list.append("6 Свиновье")
list.append("7 Жабино")
list.append("8 Хреновое")
