...
#Ставм в лабиринт по заданным координатам ключ
...
def entrance_exit(maze):
    ...
    while True:
        try:
            ...
            if maze[start_row][start_col] == ' ':
                ...
                print("Выбранная клетка не пустоя. Введите ещё раз.")
        except (ValueError, IndexError):
            print("Неправильные координаты. Введите ещё раз.")
    ...
    return start, end
# Алгоритм жадный для поиска маршрута от начальной координаты аватара до ключа
def greedy_search(maze, start, goal): 
    ...
    return None
# А* поиск оптимального пути до ближайшего выхода
